...
//   private sourceFileNames: { fileName: string; mimeType: string }[] = [];
...
//     this.targetModel = this.configService.get<string>("TARGET_MODEL", "gemini-2.0-flash-001"); // 기본 모델을 Gemini-2.0-Flash로 변경
//   }
