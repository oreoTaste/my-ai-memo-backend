...
export class ListFileDto extends PickType(UploadFile, ["seq", "fileName", 'googleDriveFileId'] as const){}
...
export class DeleteFileDto extends PickType(UploadFile, ["seq"] as const){}
